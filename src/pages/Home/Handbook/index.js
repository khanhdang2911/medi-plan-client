		...
		<Box sx={{ width: '270px', cursor: 'pointer' }}>
			...
			>
				...
				<Box sx={{ height: '72px' }}>
					...
					>
						Hệ thống Y tế Thu Cúc TCI: Có tốt không, hướng dẫn đặt khám, đi khám dễ dàng,Hệ thống Y tế Thu Cúc TCI: Có tốt không, hướng dẫn đặt khám, đi khám dễ
						dàng, Hệ thống Y tế Thu Cúc TCI: Có tốt không, hướng dẫn đặt khám, đi khám dễ dàng
					</Typography>
				</Box>
			</Link>
		</Box>
