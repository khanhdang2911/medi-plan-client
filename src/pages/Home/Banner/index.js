...
const BannerHome = () => {
	return (
		<Box sx={{ display: 'flex', justifyContent: 'center', height: '300px', bgcolor: 'rgb(146 215 239)' }}>
			<Box sx={{ width: (theme) => theme.booking_care.WIDTH_COMMON }}>
				...
				<Box sx={{ display: 'flex', justifyContent: 'center', mt: '15px' }}>
					<Box sx={{ display: 'flex', justifyContent: 'space-between', padding: '20px', width: '100%', bgcolor: 'white', borderRadius: '20px' }}>
						<TextField
